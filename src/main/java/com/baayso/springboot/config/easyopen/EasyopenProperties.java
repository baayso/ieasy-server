...
/**
 * https://gitee.com/durcframework/easyopen/blob/master/easyopen-starter/easyopen-spring-boot-starter/src/main/java/com/gitee/easyopen/spring/boot/autoconfigure/EasyopenProperties.java
 *
 * @author tanghc
 */
